            ...
            <div class="card bg-base-100 shadow-sm">
                <div class="card-body p-6">
                    <div class="flex items-start justify-between gap-4">
                        ...
                        <button class="btn btn-outline btn-sm rounded-full border-gray-300 text-gray-700 transition-colors duration-200 hover:border-[#D8C3A7] hover:bg-[#F4EEDF] hover:text-gray-900">
                            View history
                        </button>
                    </div>
                    ...
                    <table class="table table-zebra">
                        ...
                        <tbody>
                            <tr class="cursor-pointer hover:bg-base-200 transition-colors business-row border-l-4 border-transparent"
                                ...
                                <td>
                                    <div class="flex justify-end">
                                        <a href="{{ route('admin.businesses.edit', 'dakong-balay') }}" class="btn btn-outline btn-sm inline-flex items-center gap-2 rounded-full border-gray-300 whitespace-nowrap text-gray-700 transition-colors duration-200 hover:border-[#D8C3A7] hover:bg-[#F4EEDF] hover:text-gray-900">
                                            <svg viewBox="0 0 24 24" class="h-4 w-4 fill-current" aria-hidden="true">
                            ...
                            <tr class="cursor-pointer hover:bg-base-200 transition-colors business-row border-l-4 border-transparent"
                                ...
                                <td>
                                    <div class="flex justify-end">
                                        <a href="{{ route('admin.businesses.edit', 'monclaire-pool') }}" class="btn btn-outline btn-sm inline-flex items-center gap-2 rounded-full border-gray-300 whitespace-nowrap text-gray-700 transition-colors duration-200 hover:border-[#D8C3A7] hover:bg-[#F4EEDF] hover:text-gray-900">
                                            <svg viewBox="0 0 24 24" class="h-4 w-4 fill-current" aria-hidden="true">
                                                <path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zm18-10.5a1 1 0 0 0 0-1.41l-2.34-2.34a1 1 0 0 0-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/>
                                            </svg>
                                            Edit
                            ...
                            <tr class="cursor-pointer hover:bg-base-200 transition-colors business-row border-l-4 border-transparent"
                                ...
                                <td>
                                    <div class="flex justify-end">
                                        <a href="{{ route('admin.businesses.edit', 'villa-carmelita') }}" class="btn btn-outline btn-sm inline-flex items-center gap-2 rounded-full border-gray-300 whitespace-nowrap text-gray-700 transition-colors duration-200 hover:border-[#D8C3A7] hover:bg-[#F4EEDF] hover:text-gray-900">
                                            <svg viewBox="0 0 24 24" class="h-4 w-4 fill-current" aria-hidden="true">
                                                <path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zm18-10.5a1 1 0 0 0 0-1.41l-2.34-2.34a1 1 0 0 0-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/>
                                            </svg>
                                            Edit
                ...
                <div class="card-body p-6">
                    ...
                    <form id="edit-business-form" class="mt-6 space-y-6">
                        ...
                        <div class="flex flex-col gap-3 rounded-2xl border border-dashed border-gray-300 bg-[#FAF8F4] p-4 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <button type="button" class="btn btn-outline rounded-full border-gray-300 text-gray-700 transition-colors duration-200 hover:border-[#D8C3A7] hover:bg-[#F4EEDF] hover:text-gray-900">
                                Replace image
                            </button>
                        </div>
