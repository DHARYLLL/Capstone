        ...
        <section class="rounded-[2rem] border border-[#e2e8f0] bg-white p-6 shadow-sm lg:p-8">
            <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
                ...
                <div class="flex gap-3">
                    <button class="btn btn-outline rounded-full border-brand-border text-gray-700 hover:bg-[#f5f3ff]">Filter by severity</button>
                    <button class="btn rounded-full border-0 bg-brand-primary text-white hover:bg-[#6d28d9]">Retry webhook</button>
                </div>
            </div>
        </section>
            ...
            <div class="card bg-base-100 shadow-sm">
                <div class="card-body p-6 lg:p-8">
                    ...
                    <div class="mt-4 space-y-3">
                        <div class="rounded-2xl bg-[#ffffff] p-4">Critical: webhook delivery failed for tenant Monclaire Pool</div>
                        <div class="rounded-2xl bg-[#ffffff] p-4">Warning: elevated fallback routing detected for Dakong Balay</div>
                        <div class="rounded-2xl bg-[#ffffff] p-4">Info: Supabase storage sync completed successfully</div>
                        <div class="rounded-2xl bg-[#ffffff] p-4">Info: tenant Villa Carmelita knowledge sync finished</div>
                    </div>
                </div>
            </div>
