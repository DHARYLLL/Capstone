    ...
    <div class="space-y-8">
        <section class="rounded-[2rem] border border-[#e2e8f0] bg-white p-6 shadow-sm lg:p-8">
            <div class="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                <div class="space-y-3">
                    <div class="badge border-0 bg-[#f5f3ff] px-4 py-2 text-xs font-semibold uppercase tracking-[0.22em] text-brand-primary">Ecosystem command center</div>
                ...
                <div class="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
                    @foreach ($kpis as $kpi)
                        <div class="rounded-[1.5rem] border border-[#e2e8f0] bg-[#ffffff] p-4 shadow-sm">
                            ...
                            <div class="mt-1 text-xs text-brand-primary">{{ $kpi['delta'] }}</div>
                        </div>
                    @endforeach
                </div>
            </div>
        ...
        <section class="grid gap-6 lg:grid-cols-[2fr_1fr]">
            <div class="card bg-base-100 shadow-sm">
                <div class="card-body p-6 lg:p-8">
                    ...
                    <div class="mt-6 h-72 rounded-[2rem] bg-[#ffffff] p-6">
                        <div class="flex h-full items-end gap-3">
                            ...
                            <div class="h-[72%] flex-1 rounded-t-2xl bg-brand-primary"></div>
            ...
            <div class="card bg-base-100 shadow-sm">
                <div class="card-body p-6 lg:p-8">
                    ...
                    <div class="mt-4 space-y-3 text-sm text-gray-600">
                        <div class="rounded-2xl bg-[#ffffff] p-4">Supabase storage: 72% used</div>
                        <div class="rounded-2xl bg-[#ffffff] p-4">Database load: 41% / stable</div>
                        <div class="rounded-2xl bg-[#ffffff] p-4">Webhook delivery: 99.4% success</div>
                        <div class="rounded-2xl bg-[#ffffff] p-4">Fallback routing: 1 branch flagged</div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
                ...
                <div class="card-body p-6 lg:p-8">
                    ...
                    <div class="mt-5 space-y-3">
                        @foreach ($timeline as $event)
                            <div class="flex gap-4 rounded-2xl border border-[#e2e8f0] bg-[#ffffff] p-4">
                                <div class="w-16 shrink-0 text-sm font-semibold text-brand-primary">{{ $event['time'] }}</div>
            ...
            <div class="card bg-base-100 shadow-sm">
                <div class="card-body p-6 lg:p-8">
                    ...
                    <div class="mt-4 space-y-3 text-sm text-gray-600">
                        <div class="rounded-2xl bg-[#f8fafc] p-4">1 tenant showing elevated human handoff rate</div>
                        <div class="rounded-2xl bg-[#f8fafc] p-4">Supabase webhook retry observed for one delivery</div>
                        <div class="rounded-2xl bg-[#f8fafc] p-4">All AI links connected and responsive</div>
                    </div>
                </div>
            </div>
        </section>
