...
<aside class="sticky top-0 hidden h-screen w-72 shrink-0 flex-col overflow-hidden border-r border-gray-200 bg-base-100 md:flex">
    <div class="border-b border-gray-200 px-6 py-5">
        <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3">
            <div class="flex h-11 w-11 items-center justify-center rounded-2xl bg-brand-primary text-white shadow-sm text-xl">
                ☔
            </div>
            <div>
                <div class="text-base font-extrabold tracking-tight text-gray-900 leading-tight">AquaShield</div>
