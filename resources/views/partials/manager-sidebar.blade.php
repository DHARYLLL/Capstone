    ...
    <nav class="min-h-0 flex-1 overflow-y-auto px-4 py-5">
        @php
            $mgrNav = [
                ...
                ['label' => 'Products & Services',   'href' => route('admin.businesses.manager-products',  $slug), 'route' => 'admin.businesses.manager-products',   'icon' => 'M19 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2zm-7 3a3 3 0 1 1 0 6 3 3 0 0 1 0-6zm6 12H6v-.5c0-2 4-3.1 6-3.1s6 1.1 6 3.1V18z'],
