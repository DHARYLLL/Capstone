        ...
        <section class="grid gap-6 md:grid-cols-[1fr_2fr]">
            ...
            <div class="card bg-base-100 shadow-sm h-fit">
                <div class="card-body p-6 flex flex-col items-center text-center space-y-4">
                    <div class="flex h-20 w-20 items-center justify-center rounded-3xl bg-purple-100 text-purple-700 font-bold text-3xl shadow-sm">
                        {{ $userAvatar }}
                    </div>
                    <div>
                        <h2 class="text-xl font-bold text-gray-900">{{ $userName }}</h2>
                        <p class="text-xs font-semibold text-indigo-600 uppercase tracking-wider mt-1">{{ $userRole }}</p>
            ...
            <div class="card bg-base-100 shadow-sm">
                <div class="card-body p-6">
                    ...
                    <form action="{{ route('staff.settings.post') }}" method="POST" class="space-y-5">
                        @csrf
